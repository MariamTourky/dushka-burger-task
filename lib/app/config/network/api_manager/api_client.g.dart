...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<HttpResponse<List<CategoriesResponse>>> getCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<CategoriesResponse>>>(
    ...
    late List<CategoriesResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
  ...
  Future<HttpResponse<ProductAddonsResponse>> getProductAddons(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProductAddonsResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'proaddon/v1/get2',
    ...
    late ProductAddonsResponse _value;
    try {
  ...
  @override
  Future<HttpResponse<GuestIdResponse>> getGuestId() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GuestIdResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<HttpResponse<void>> addToCart(AddToCartRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<void>> deleteFromCart(DeleteFromCartRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
